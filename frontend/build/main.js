...
var _user$project$Types$Status = F3(
	function (a, b, c) {
		return {tables: a, line_cooks: b, chef: c};
	});
var _user$project$Types$StatusError = function (a) {
	return {ctor: 'StatusError', _0: a};
};
var _user$project$Types$NewStatus = function (a) {
	return {ctor: 'NewStatus', _0: a};
};
var _user$project$Types$Tick = {ctor: 'Tick'};
var _user$project$Types$NoOp = {ctor: 'NoOp'};

var _user$project$Api$tableDecoder = A4(
...
var _user$project$Api$lineCookDecoder = A3(
	...
	A2(
		...
		'dishes',
		_elm_lang$core$Json_Decode$list(_elm_lang$core$Json_Decode$string)));
var _user$project$Api$chefDecoder = A3(
	_elm_lang$core$Json_Decode$object2,
	...
	A2(
		...
		'orders',
		_elm_lang$core$Json_Decode$list(_elm_lang$core$Json_Decode$string)));
var _user$project$Api$statusDecoder = A4(
	_elm_lang$core$Json_Decode$object3,
	_user$project$Types$Status,
	A2(
		_elm_lang$core$Json_Decode_ops[':='],
		'tables',
		_elm_lang$core$Json_Decode$list(_user$project$Api$tableDecoder)),
	A2(
		_elm_lang$core$Json_Decode_ops[':='],
		'line_cooks',
		_elm_lang$core$Json_Decode$list(_user$project$Api$lineCookDecoder)),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'chef', _user$project$Api$chefDecoder));
var _user$project$Api$getStatus = function () {
	var req = A2(_evancz$elm_http$Http$get, _user$project$Api$statusDecoder, '/status');
	return A3(_elm_lang$core$Task$perform, _user$project$Types$StatusError, _user$project$Types$NewStatus, req);
}();
...
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		switch (_p0.ctor) {
			...
			case 'Tick':
				return {ctor: '_Tuple2', _0: model, _1: _user$project$Api$getStatus};
			case 'NewStatus':
				return {
					ctor: '_Tuple2',
			...
			default:
				var dbg = A2(_elm_lang$core$Debug$log, 'error', _p0._0);
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
		}
	});
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(
						_elm_lang$core$Basics$toString(table.number))
					])),
				A2(
				_elm_lang$html$Html$span,
				_elm_lang$core$Native_List.fromArray(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(
						_elm_lang$core$Basics$toString(table.size))
					])),
				A2(
				_elm_lang$html$Html$span,
				_elm_lang$core$Native_List.fromArray(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(
						A2(_elm_lang$core$String$join, ', ', table.dishes))
					]))
			]));
};
...
var _user$project$Main$main = {
	main: _elm_lang$html$Html_App$program(
		{
			init: {ctor: '_Tuple2', _0: _user$project$Main$model, _1: _user$project$Api$getStatus},
