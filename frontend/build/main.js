...
var _user$project$Types$FastChef = {ctor: 'FastChef'};
var _user$project$Types$SlowChef = {ctor: 'SlowChef'};
var _user$project$Types$FastLineCook = {ctor: 'FastLineCook'};
var _user$project$Types$SlowLineCook = {ctor: 'SlowLineCook'};
var _user$project$Types$Config = function (a) {
...
var _user$project$Data$encodeOption = function (option) {
	var _p0 = option;
	switch (_p0.ctor) {
		case 'SlowLineCook':
			return 'slow-line-cook';
		case 'FastLineCook':
			return 'fast-line-cook';
		case 'SlowChef':
			return 'slow-chef';
		default:
			return 'fast-chef';
...
var _user$project$Data$lineCookDecoder = A3(
	_elm_lang$core$Json_Decode$map2,
	_user$project$Types$LineCook,
...
var _user$project$Data$orderDecoder = A3(
	...
	A2(_elm_lang$core$Json_Decode$field, 'table_number', _elm_lang$core$Json_Decode$int),
	A2(
		_elm_lang$core$Json_Decode$field,
		'orders',
		_elm_lang$core$Json_Decode$list(_elm_lang$core$Json_Decode$string)));
var _user$project$Data$statusDecoder = A6(
	...
	A2(_elm_lang$core$Json_Decode$field, 'waiter_queue', _elm_lang$core$Json_Decode$int),
	A2(
		_elm_lang$core$Json_Decode$field,
		'line_cooks',
	...
	A2(_elm_lang$core$Json_Decode$field, 'error_count', _elm_lang$core$Json_Decode$int));

var _user$project$Main$wsServer = 'ws://localhost:4001/ws';
var _user$project$Main$updateConfig = function (option) {
	return A2(
		_elm_lang$websocket$WebSocket$send,
		_user$project$Main$wsServer,
		_user$project$Data$encodeOption(option));
};
var _user$project$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: A2(_elm_lang$websocket$WebSocket$listen, _user$project$Main$wsServer, _user$project$Types$SocketMsg),
			_1: {
				ctor: '::',
				_0: _elm_lang$websocket$WebSocket$keepAlive(_user$project$Main$wsServer),
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		switch (_p0.ctor) {
			...
			case 'SocketMsg':
				var _p1 = A2(_elm_lang$core$Json_Decode$decodeString, _user$project$Data$statusDecoder, _p0._0);
				if (_p1.ctor === 'Ok') {
					return {
						ctor: '_Tuple2',
			...
			default:
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _user$project$Main$updateConfig(_p0._0)
				};
		}
	});
var _user$project$Main$configBar = A2(
		...
		_0: A2(
			_elm_lang$html$Html$button,
			{
				...
				_0: _elm_lang$html$Html_Events$onClick(
					_user$project$Types$Config(_user$project$Types$SlowLineCook)),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text('Get line cooks drunk'),
				_1: {ctor: '[]'}
			}),
		_1: {
			ctor: '::',
			_0: A2(
				_elm_lang$html$Html$button,
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onClick(
						_user$project$Types$Config(_user$project$Types$FastLineCook)),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Give line cooks an energy drink'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$button,
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onClick(
							_user$project$Types$Config(_user$project$Types$SlowChef)),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Chef gets a papercut'),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						_elm_lang$html$Html$button,
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onClick(
								_user$project$Types$Config(_user$project$Types$FastChef)),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Chef uses a plaster'),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
...
var _user$project$Main$lostTables = function (errorCount) {
	...
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('lost-tables'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text(dish),
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		});
	...
	return A2(
		_elm_lang$html$Html$div,
		{
			...
			_0: _elm_lang$html$Html_Attributes$classList(
				{
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'chef', _1: true},
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'critical', _1: isCritical},
						_1: {ctor: '[]'}
					}
				}),
			_1: {ctor: '[]'}
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Chef'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
	...
	return A2(
		_elm_lang$html$Html$div,
		{
			...
			_0: _elm_lang$html$Html_Attributes$classList(
				{
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'waiter', _1: true},
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'critical', _1: isCritical},
						_1: {ctor: '[]'}
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Waiter'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
								...
								_0: A2(
									...
									{ctor: '[]'},
									{
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$class('narrow'),
												_1: {ctor: '[]'}
											},
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('orders count'),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}),
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text(lineCook.area),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
...
var _user$project$Main$lineCookList = function (lineCooks) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('line-cooks'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Line Cooks'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
								...
								_0: A2(
									...
									{ctor: '[]'},
									{
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('area'),
												_1: {ctor: '[]'}
											}),
										_1: {
											ctor: '::',
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text('dishes'),
													_1: {ctor: '[]'}
												}),
											_1: {ctor: '[]'}
										}
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('phase narrow'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('number narrow'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(
							_elm_lang$core$Basics$toString(tb.number)),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('size narrow'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(
								_elm_lang$core$Basics$toString(tb.size)),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							...
							{ctor: '[]'},
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text(
									_user$project$Main$dishIndicator(tb.dishes)),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
...
var _user$project$Main$tableList = function (tables) {
	...
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('tables'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
					...
					{ctor: '[]'},
					{
								...
								_0: A2(
									...
									{ctor: '[]'},
									{
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('phase'),
												_1: {ctor: '[]'}
											}),
										_1: {
											ctor: '::',
						...
						_1: {
							...
							_0: A2(
								_elm_lang$html$Html$tbody,
								{ctor: '[]'},
								A2(_elm_lang$core$List$map, _user$project$Main$tableItem, sortedTables)),
							_1: {ctor: '[]'}
						}
					}),
				_1: {ctor: '[]'}
		...
		return A2(
			...
			{ctor: '[]'},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Osteria'),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _user$project$Main$configBar,
							_1: {
								ctor: '::',
								_0: _user$project$Main$lostTables(_p5.errorCount),
								_1: {ctor: '[]'}
							}
						}),
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _user$project$Main$tableList(_p5.tables),
								_1: {
									ctor: '::',
									_0: _user$project$Main$waiterStatus(_p5.waiterQueue),
									_1: {
										ctor: '::',
										_0: _user$project$Main$chefStatus(_p5.chefOrders),
										_1: {
											ctor: '::',
											_0: _user$project$Main$lineCookList(_p5.line_cooks),
											_1: {ctor: '[]'}
										}
									}
								}
...
var _user$project$Main$model = _elm_lang$core$Maybe$Nothing;
