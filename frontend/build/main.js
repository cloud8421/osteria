...
var _user$project$Data$lineCookDecoder = A3(
	...
	A2(_elm_lang$core$Json_Decode_ops[':='], 'area', _elm_lang$core$Json_Decode$string),
	A2(
		_elm_lang$core$Json_Decode_ops[':='],
		'dishes',
		_elm_lang$core$Json_Decode$list(_elm_lang$core$Json_Decode$string)));
...
var _user$project$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		_elm_lang$core$Native_List.fromArray(
			[
				A2(_elm_lang$websocket$WebSocket$listen, _user$project$Main$wsServer, _user$project$Types$SocketMsg),
				_elm_lang$websocket$WebSocket$keepAlive(_user$project$Main$wsServer)
			]));
};
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Tables')
					])),
				A2(
				_elm_lang$html$Html$table,
				_elm_lang$core$Native_List.fromArray(
...
var _user$project$Main$view = function (model) {
	...
	if (_p4.ctor === 'Just') {
		...
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html$text('Wait for it...')
				]));
	}
};
